...
body2 = Body(Point(0, 9, 45))

body2.left_arm.set_slocal_rotate_angle(0, 0, 180)
body2.right_arm.set_slocal_rotate_angle(0, 0, 180)
body2.left_leg.set_hlocal_rotate_angle(0, 0, 180)
body2.right_leg.set_hlocal_rotate_angle(0, 0, 180)
...
while (index < num_images):
    ...
    body2.left_arm.set_joint_angles(left_shoulder_angles['p'], left_shoulder_angles['y'], left_shoulder_angles['r'], left_elbow_angle)
    body2.right_arm.set_joint_angles(right_shoulder_angles['p'], right_shoulder_angles['y'], right_shoulder_angles['r'], right_elbow_angle)
    body2.left_leg.set_joint_angles(left_hip_angles['p'], left_hip_angles['y'], left_hip_angles['r'], left_knee_angle)
    body2.right_leg.set_joint_angles(right_hip_angles['p'], right_hip_angles['y'], right_hip_angles['r'], right_knee_angle)
    ...
    if (body.is_collision_body_parts() == False):
        ...
        for prop in body2.get_property_list():
            scene.addChild(pmgr.create(prop))
