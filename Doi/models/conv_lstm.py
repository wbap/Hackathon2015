...
"""
class syuwa_conv_lstm(FunctionSet):
    ...
    def forward_one_step(self, x_vis, x_dep, train_label, c, h, volatile=False):
        ...
        h1 = F.relu(self.bn11(self.conv11(x1)))
        h1 = F.relu(self.bn12(self.conv12(h1)))
        ...
        h2 = F.relu(self.bn21(self.conv21(x2)))
        h2 = F.relu(self.bn22(self.conv22(h2)))
