...
if __name__ == "__main__":
    ...
    for epoch in xrange(n_epoch):
        ...
        for batchnum in xrange(0 , N_train, batchsize):
            ...
            with open('./mfccdatalog4/tdata_train.csv','a') as f:
                writer = csv.writer(f)
                writer.writerows(t_array)
                t_array = []
            
            with open('./mfccdatalog4/ydata_train.csv','a') as f:
                writer = csv.writer(f)
        ...
        with open('./mfccdatalog4/train_loss.csv','w') as f:
            writer = csv.writer(f)
            writer.writerow(trainloss)

        with open('./mfccdatalog4/train_accuracy.csv','w') as f:
            writer = csv.writer(f)
        ...
        for batchnum in xrange(0 , N_test, batchsize):
            ...
            with open('./mfccdatalog4/tdata_test.csv','a') as f:
                writer = csv.writer(f)
                writer.writerows(t_array)
                t_array = []
            
            with open('./mfccdatalog4/ydata_test.csv','a') as f:
                writer = csv.writer(f)
                writer.writerows(y_array)
                y_array = []
        ...
        with open('./mfccdatalog4/l1_x_W.csv','a') as f:
            writer = csv.writer(f)
            writer.writerows(l1_x_W)
            l1_x_W = []

        with open('./mfccdatalog4/l1_h_W.csv','a') as f:
            writer = csv.writer(f)
            writer.writerows(l1_h_W)
            l1_h_W = []

        with open('./mfccdatalog4/l2_x_W.csv','a') as f:
            writer = csv.writer(f)
            writer.writerows(l2_x_W)
            l2_x_W = []

        with open('./mfccdatalog4/l2_h_W.csv','a') as f:
            writer = csv.writer(f)
            writer.writerows(l2_h_W)
            l2_h_W = []

        with open('./mfccdatalog4/l3_W.csv','a') as f:
            writer = csv.writer(f)
            writer.writerows(l3_W)
            l3_W = []

        with open('./mfccdatalog4/test_loss.csv','w') as f:
            writer = csv.writer(f)
            writer.writerow(testloss)

        with open('./mfccdatalog4/test_accuracy.csv','w') as f:
            writer = csv.writer(f)
